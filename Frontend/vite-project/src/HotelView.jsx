        ...
        <div className='container-fluid gx-5'>
            ...
            <div id='hotelview' className="row border py-3 px-3 mt-5">
                ...
                <div className="col-lg-8 col-md-8">
                    <div className="row">
                        <div className="col-8">
                            <img src={`${selectHotelDetail.thumbnail}`} style={{ width: '100%' }} alt="..." />
                        </div>
                        <div className="col-4">
                ...
                <div className="col-lg-4 col-md-4 border rounded-3 py-3">
            ...
            <div  className="container-fluid row gx-3 gy-5 mt-5 mb-5">
