    ...
    <div className='d-flex' style={{backgroundColor:"#eeedf2"}}>
      ...
      <div className='form_container d-flex flex-column align-items-center '>
        <form className='auth_form' onSubmit={(e) => registerFormFun(e)} style={{margin: 'auto', marginTop: '50px' }}>
          ...
          <div class="mb-3 d-flex gap-4 pass">
            <div className='flex-grow-1 exampleInputPassword1'>
            <label htmlFor="exampleInputPassword1" class="form-label">Password</label>
            <input type="text" name='password' class="form-control" id="exampleInputPassword1" />
            </div>
             <div className='flex-grow-1 exampleInputPassword2'>
            <label htmlFor="exampleInputPassword2" class="form-label">Confirm Password</label>
            <input type="text" name='password1' class="form-control" id="exampleInputPassword2" />
            </div>
          </div>

          <button type="submit" class="btn btn-primary fw-bold" style={{backgroundColor:"#7352d7",border:"none"}}>SIGN UP</button>
          <div className='mt-3'>
